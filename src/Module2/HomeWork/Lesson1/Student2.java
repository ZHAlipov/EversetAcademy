...
public class Student2 {
    ...
    public Student2(String name, int mark_math, int mark_english, int mark_programing) {
        this.name = name;
...
class Student2Test {
    public static void main(String[] args) {
        ...
        students[0] = new Student2("Tomas Anderson", 5, 5, 4);
        students[1] = new Student2("Steve White", 3, 3, 4);
        students[2] = new Student2("Anna Smith", 4, 2, 5);
        students[3] = new Student2("Jackson Turley", 2, 4, 3);
        students[4] = new Student2("Katty Bree", 3, 5, 4);

        for (int i = 0; i < 5; i++) {
            result = Student2.sredniiBal(students[i].getMark_math(), students[i].getMark_english(), students[i].getMark_programing());
            if (result >= 4) {
